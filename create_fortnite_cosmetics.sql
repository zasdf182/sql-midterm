...
('Zuko Pack', 'TikiTorch_Bundle', 2000, 'Rare', 3),
...
('FNCS Invitational 2022 Bundle', 'FNCS22_Bundle', 2300, 'Rare', 6),
...
('Quickstrike', 'Pickaxe_ID_172_BandageNinja', 'Rare', 500, 'Falcon Clan', 'Falcon Clan Bundle'),
('Talons', 'Pickaxe_ID_219_BandageNinja1H', 'Rare', 800, 'Falcon Clan', 'Falcon Clan Bundle'),
('Simple Sledge', 'Pickaxe_ID_213_AssassinSuitSledgehammer', 'Rare', 500, 'John Wick', 'John Wick'),
('Wick''s Katana', 'Pickaxe_TracePaper', 'Rare', 500, 'John Wick', 'John Wick');

INSERT INTO music (music_name, music_id, rarity, set_name, song_length) VALUES
('Coral Chorus', 'MusicPack_008_Coral', 3 , 'Fish Food', 149),
('Loot In The Mountains', 'MusicPack_117_WinterFest2021', 'Rare', 'Winterfest ''21', 183),
('Somebody This Fly', 'MusicPack_122_Sleek_3ST6M', 'Icon Series', 'Silk Sonic', 219),
('Streets Ignite', 'MusicPack_200_JamTrack', 'Rare', 'TMNT', 173),
...
('Flip Reset', 'MusicPack_073_RL2PromoTrack',  'Rare', 'Rocket League', 184);
